...
export class AuthServiceProvider {
  ...
  public getVotingBallots() {
    ...
    return this.http.post("https://vortexmobievotingapp.000webhostapp.com/vortex/api/getVotingBallots.php",JSON.stringify({"username":this.username})).map(res => res.json());
  }
